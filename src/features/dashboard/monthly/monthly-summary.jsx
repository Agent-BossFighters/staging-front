        ...
        <div className="pb-4 flex flex-col items-center gap-2">
          <div className="flex gap-4">
            <div className="flex items-center gap-1">
              ...
              <span className="text-green-500 text-2xl">{formatNumber(metrics.total_wins || 0)}</span>
            </div>
            <div className="flex items-center gap-1">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="pl-1 text-red-500 text-2xl">{formatNumber(metrics.total_losses || 0)}</span>
            </div>
          </div>
