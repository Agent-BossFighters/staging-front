...
export default function Tactics() {
  ...
  const { currencyPacks, loading, error, fetchCurrencyPacks } = useCurrencyPacks();
  ...
  const formatSelectedValue = (value) => {
    ...
    const pack = currencyPacks.find(p => p.currencyNumber.toString() === value);
        ...
        <div className="flex flex-col">
          ...
          >
            <SelectTrigger className="inline-flex items-center gap-1 w-[200px] px-4 py-2">
              <SelectValue>
                {formatSelectedValue(selectedPack)}
              </SelectValue>
            </SelectTrigger>
            <SelectContent>
